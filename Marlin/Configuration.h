...
#define STRING_CONFIG_H_AUTHOR "(lpierre, 28-01-2022, SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa I3 SKR 1.4 Jayjay"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, 5, -0.1 }
